\section*{Экземпляры объекта "Коммерческие организации"}
...
\begin{lstlisting}[language=SPARQL,label=nameless,caption={Список организаций, у которых указано имя в Викиданных на английском языке}]
